  ...
  data() {
    return {
      ...
      form: {
        ...
        birth: this.$store.getters.getUser.birth,
        sex: this.$store.getters.getUser.sex,
        address: this.$store.getters.getUser.address,
        grade: this.$store.getters.getUser.grade,
        major: this.$store.getters.getUser.major,
        position: this.$store.getters.getUser.position,
        admissionTime: this.$store.getters.getUser.admissionTime,
        graduationTime: this.$store.getters.getUser.graduationTime,
        siid:this.$store.getters.getUser.siid,
    ...
    submit() {
      this.$refs.form.validate().then((result)=>{
        ...
        const formData={
            ...
            admissionTime: this.form.admissionTime,
